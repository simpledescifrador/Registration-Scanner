...
public class CommonPreferenceHelper implements BasePreferenceHelper {

    //Shared Prefs Name
    private static final String NAME_PREF = "AppSharedPref_Default";

    private final SharedPreferences preferences;

    public CommonPreferenceHelper(@ApplicationContext Context context) {
